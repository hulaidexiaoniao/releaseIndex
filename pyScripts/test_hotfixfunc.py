...
class TestDownLoadCheckListTest():
    ...
    标准输入为 "\\"+ 文件名 ，例： \\ddd.txt
    """
    @pytest.mark.parametrize("str1, boolee", [("\\ddd.txt", True), ("\\1, 2", True), ("\\ddd.log", True),("\\  ",False),("\\dd  dd.txt",True),(None,False)])
...
class TestGetLocalFileInfo():
    ...
    参数2为生成文件的放置路径及文件名，类型为str
    """
    @pytest.mark.parametrize("str1,str2,getSucceed",[(r"C:\Users\wulongan\Desktop\pyunittest\updateTemp",r"C:\Users\wulongan\Desktop\pyunittest\updateTemp\ss.txt",True),
    (os.getcwd(),os.getcwd() + "\\updateTemp\\cc.txt",True),("asddasd","asdsaggdsa",False),("","",False),("","nn.txt",False)])
...
class TesttxtParse():
   ...
   参数是对比文件的路径， 参数类型为str，路径如果不存在，返回的字典为空
    """
    @pytest.mark.parametrize("str1",[(r"C:\Users\wulongan\Desktop\pyunittest\updateTemp\ss.txt"),(r"C:\Users\wulongan\Desktop\python--"),("sdasd"),(""),(" ")])
...
class TestdateCompare():
    ...
    def test_date_compare(self,set_up):
        dic1 = hotfixFunc.txt_parse(r"C:\Users\wulongan\Desktop\python--\tree.txt")
        dic2 = hotfixFunc.txt_parse(r"C:\Users\wulongan\Desktop\python--\tree2.txt")
...
class TestgetAddFile():
    ...
    def test_get_add_file(self,set_up):
        dic1 = hotfixFunc.txt_parse(r"C:\Users\wulongan\Desktop\python--\tree.txt")
        dic2 = hotfixFunc.txt_parse(r"C:\Users\wulongan\Desktop\python--\tree2.txt")
        addlist = hotfixFunc.get_add_file(dic1,dic2)
        print(addlist)
        print("**********************************************************************")

class TestDownloadFile():
    """ down_load_file(needRepalceFile: list, needAddFile: list, baseUrlAddress: str = "https://edahotfix.oss-cn-hangzho") -> bool
...
class TestmoveFile():
    ...
    参数2类型为list,是通过get_add_file生成的list,存储需要增加的文件的相对路径
    """
    def test_move_file(self,set_up):
        list1 = ['EPEDAPro\\resources\\images\\export_success.png', 'EPEDAPro\\Translator\\Chinese\\matrix_zh.qm', 
        'EPEDAPro\\rangesconfig\\SurfaceAnalyzer\\SurfaceAnalyzerRanges.json', 'EPEDAPro\\Translator\\Chinese\\cam_menubar_actions_zh.qm',
         'EPEDAPro\\Translator\\Chinese\\graphic_coordinate_zh.qm', 'EPEDAPro\\CAMGuide\\base\\epcam\\epcam.py', 'EPEDAPro\\Viewbar_View.dll', 
         'EPEDAPro\\zlibwapi.dll', 'EPEDAPro\\CAMGuide\\PreGuide\\Net\\drill_classify_attribute.py', 'EPEDAPro\\vcruntime140_1.dll',
...
class TestJudgeFileWritable():
    def test_judge_file_writable(self,set_up):
        list1 = ['EPEDAPro\\resources\\images\\export_success.png', 'EPEDAPro\\Translator\\Chinese\\matrix_zh.qm', 
        'EPEDAPro\\rangesconfig\\SurfaceAnalyzer\\SurfaceAnalyzerRanges.json', 'EPEDAPro\\Translator\\Chinese\\cam_menubar_actions_zh.qm',
         'EPEDAPro\\Translator\\Chinese\\graphic_coordinate_zh.qm', 'EPEDAPro\\CAMGuide\\base\\epcam\\epcam.py', 'EPEDAPro\\Viewbar_View.dll', 
         'EPEDAPro\\zlibwapi.dll', 'EPEDAPro\\CAMGuide\\PreGuide\\Net\\drill_classify_attribute.py', 'EPEDAPro\\vcruntime140_1.dll',
